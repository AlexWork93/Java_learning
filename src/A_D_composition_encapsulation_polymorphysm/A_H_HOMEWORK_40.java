...
public class A_H_HOMEWORK_40 {
    ...
    // class should be overridden to generate a message appropriate to the type of burger along with any addons. The method also returns the total price of the healthy burger of type double.
    //Example input:
    //
...
class Hamburger {
    ...
    public double itemizeHamburger() {
        System.out.printf("%s hamburger on a %s with %s, price is %s\n", name, breadRollType, meat, price);
...
class DeluxeBurger extends Hamburger{
    ...
    @Override
    public double itemizeHamburger() {
        double temp = super.itemizeHamburger();
        System.out.println("Added Chips for an extra 2.75\n" +
                "Added Drink for an extra 1.81");
        return 2.75 + 1.81 + temp;
    }
}
...
class HealthyBurger extends Hamburger{
    ...
    public double itemizeHamburger() {
        ...
        return healthyExtra1Price + healthyExtra2Price + temp;
    }
}
